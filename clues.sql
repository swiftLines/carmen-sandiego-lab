...
-- select * from country;
select code, name, continent, population from country order by population;
...
select code, name, region from country where code = 'BRA';
...
-- TODO: Write SQL query here
select code, name, region, capital from country where name = 'Brazil';

-- BRA | Brazil | South America | 211
-- 'Brasilia'
